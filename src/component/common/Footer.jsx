      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full lg:w-6/12 px-4">
            <h4 className="text-3xl font-semibold text-blue-700">The Bharat Exporter</h4>
            ...
            <div className="flex flex-wrap items-top mb-6">
              <div className="w-full lg:w-4/12 px-4 ml-auto justify-center flex flex-col ">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">Home</a>
                  </li>
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">About Us</a>
                  </li>
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">Product</a>
                  </li>
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">Contact Us</a>
                  </li>
                </ul>
              </div>
              <div className="w-full lg:w-4/12 px-4">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">The Bharat Exporter Vill. Dhadhani Ghazipur UttarPradesh 232336</a>
                  </li>
                  <li>
                    <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm">7827992155</a>
                  </li>
