        ...
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full lg:w-6/12 px-4">
            ...
            <div className="mt-6 lg:mb-0 mb-6 flex">
              ...
              <button
                className="bg-white text-blue-800 shadow-lg font-normal h-10 w-10 flex items-center justify-center rounded-full outline-none focus:outline-none mr-2"
                type="button"
              >
                <FaInstagram />
              </button>
                ...
                <ul className="list-unstyled">
                  <li>
                    <a
                      ...
                      className="text-blue-600 hover:text-blue-800 font-semibold block pb-2 text-sm"
                    >
                      The Bharat Exporter Vill. Dhadhani Ghazipur UttarPradesh
                      232336
                    </a>
                  </li>
                  <li>
