...
const SupplyChain = () => {
    return (
        <section className="supply-chain-section mt-[200px]">
            ...
            <div className="relative z-10 flex  flex-col lg:flex-row items-center justify-center h-screen lg:w-[80%] mx-auto">
                ...
                <div className="lg:w-1/2 w-screen  shadow-lg rounded-lg p-6">
                    <p className="text-[#e2571a] font-fjalla italic lg:text-xl mt-4">Supply Chain Technology & Customized Solutions</p>
