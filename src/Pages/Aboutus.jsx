...
function Aboutus() {
  return (
    <div>  <p className="text-[#e2571a] font-fjalla italic text-lg">About The Bharat Exporter</p>
    <h2 className="text-[#33536B] text-4xl font-sans font-bold mt-2">Your Trusted Source for Quality Agricultural Products and Spices"</h2>
