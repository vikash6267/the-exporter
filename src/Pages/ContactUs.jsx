...
<div className=' lg:w-[28%] w-[60%]'>
  <h3 className=' text-[#33536B] lg:text-3xl font-fjalla text-xl'>Address</h3>
  <p className=' text-[#7c7c7c] lg:text-xl text-sm'>The Bharat Exporter Vill. Dhadhani Ghazipur UttarPradesh 232336</p>
</div>
<div className=' lg:w-[28%] w-[60%]'>
  <h3 className=' text-[#33536B] lg:text-3xl font-fjalla text-xl'>Call Us</h3>
  <p className=' text-[#7c7c7c] lg:text-xl text-sm'>+917827992155</p>
</div>
<div className=' lg:w-[28%] w-[60%]'>
  <h3 className=' text-[#33536B] lg:text-3xl font-fjalla text-xl'>Mail Us</h3>
  <p className=' text-[#7c7c7c] lg:text-xl text-sm'><a href="mailto:thebharatexporter@gmail.com">thebharatexporter@gmail.com
</a></p>
</div>
...
<div className="flex flex-col md:flex-row items-center justify-center mx-auto  py-12 px-4">
      ...
      <div className="lg:w-[35%] md:w-[35%] w-full md:mr-8 mb-8 md:mb-0 text-center md:text-left">
        <h2 className="text-3xl font-bold text-[#df794d] font-fjalla italic mb-4">Send A Message</h2>
        <p className="text-4xl text-gray-600 mb-4 ">
          We will be in touch shortly. .
        </p>
        <p className='text-gray-600 mb-4'>Any queries? Feel free to reach out to us</p>
